...
class GoogleDriveHelper:
            ...
            if meta.get("mimeType") == self.__G_DRIVE_DIR_MIME_TYPE:
                ...
                if INDEX_URL is not None:
                    ...
                    if SHORTENER is not None and SHORTENER_API is not None:
                        ...
                        buttons.buildbutton("Iɴᴅᴇx", siurl)
                    else:
                        buttons.buildbutton("Iɴᴅᴇx", url)
                ...
                msg += f'FɪʟᴇNᴀᴍᴇ : <code>{file.get("name")}</code>'
    ...
    def drive_list(self, fileName):
        ...
        if response["files"]:
            ...
            msg = f"<b>Sᴇᴀʀᴄʜ ʀᴇꜱᴜʟᴛꜱ ғᴏʀ: {fileName} 👇</b>"
            buttons = button_build.ButtonMaker()   
            buttons.buildbutton("Rᴇꜱᴜʟᴛꜱ", f"https://telegra.ph/{self.path[0]}")
